...
const GA_EVENT_CATEGORIES: Record<string, string> = {
  ...
  [AnalyticsEvents.TOOL_OPENED]: 'tools',
  [AnalyticsEvents.TOOL_SELECTION]: 'tools',
  [AnalyticsEvents.TOOL_RESULT_VIEWED]: 'tools',
  [AnalyticsEvents.TOOL_AFFILIATE_CLICK]: 'affiliate',
