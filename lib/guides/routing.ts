import { NURSERY_GUIDE_PARENT_SLUG, NURSERY_GUIDE_TOPIC_CLUSTER, NURSERY_SUBGUIDE_DEFINITIONS } from '@/lib/learn/nursery/vision-and-lifestyleSubguides';
import { REGISTRY_GUIDE_PARENT_SLUG, REGISTRY_GUIDE_TOPIC_CLUSTER, REGISTRY_SUBGUIDE_PATHS } from '@/lib/learn/registry/where-to-registerSubguides';

const GUIDE_PARENT_BY_CLUSTER: Record<string, string> = {
  [REGISTRY_GUIDE_TOPIC_CLUSTER]: REGISTRY_GUIDE_PARENT_SLUG,
...
const GUIDE_PARENT_BY_SLUG: Record<string, string> = {
  ...
  ...Object.fromEntries(Object.keys(REGISTRY_SUBGUIDE_PATHS).map((guide) => [guide, REGISTRY_GUIDE_PARENT_SLUG])),
