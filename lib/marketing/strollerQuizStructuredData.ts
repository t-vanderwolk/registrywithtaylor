  ...
  '@graph': [
    {
      ...
      description:
        'Answer 8 questions to get a personalized stroller recommendation from Gugu Concierge Taylor Vanderwolk. Covers lifestyle, home, vehicle, budget, and family plans. Free, with no sign-up required.',
      url: QUIZ_URL,
      ...
      featureList: [
        'Personalized stroller recommendation',
    ...
    },
    {
      ...
      description:
        'Answer 8 questions and get your personalized stroller recommendation from Gugu Concierge Taylor Vanderwolk. Free, instant results, then book a 1-hour consultation for $75.',
