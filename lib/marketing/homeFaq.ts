...
export const HOME_FAQ: HomeFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Target Baby Concierge Specialists are trained baby gear advisors placed in Target stores through the Baby Concierge program. Taylor is a Gugu Concierge, and it is the same expertise she brings to virtual consultations at Taylor-Made Baby Co.',
  },
  {
