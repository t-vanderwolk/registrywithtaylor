  ...
  '@graph': [
    {
      ...
      description:
        'One hour virtual baby registry consultation for expecting parents covering stroller selection and compatibility, car seat safety, nursery planning, feeding gear, and registry strategy. Delivered by Taylor Vanderwolk, a Gugu Concierge with hands-on baby gear experience and 200+ families helped. Independent, with no brand sponsorships or paid placements, and written follow up notes.',
    ...
    },
    {
      ...
      description:
        'Book a 1-hour virtual baby registry consultation with Gugu Concierge Taylor Vanderwolk for $75. Strollers, car seats, nursery, feeding gear, and registry strategy for expecting parents across the United States.',
    ...
    },
    {
      ...
      description:
        'Book a 1-hour virtual baby registry consultation with Gugu Concierge Taylor Vanderwolk in 4 simple steps.',
      totalTime: 'PT1H',
