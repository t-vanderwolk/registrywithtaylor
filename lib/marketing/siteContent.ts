...
export const guidePillars: GuidePillar[] = [
  ...
  },
  {
    ...
    title: 'Car Seats, Made Clear',
    shortTitle: 'Car Seats',
    description:
      'A simple explanation of car seat stages, so you can choose what actually fits your baby, your car, and your life.',
    imageSrc: '/assets/editorial/gear.jpg',
    imageAlt: 'Car seat planning editorial scene for Taylor-Made Baby Co.',
    eyebrow: 'Baby Gear Guide',
    seoTitle: 'Car Seats, Made Clear | Taylor-Made Baby Co.',
    seoDescription:
      'A calmer car seat guide that explains infant, convertible, all-in-one, and booster stages without the jargon spiral.',
    overview:
      'This hub helps families understand the car seat stages first, then move into the right next guide with more clarity and less fear-based noise.',
    focusAreas: [
      'Infant seat versus convertible starting strategy',
      'How the stages progress from newborn through booster',
      'What actually fits your baby, your car, and your routine',
    ],
    quickQuestions: [
      'Are you starting from birth or planning past the newborn stage already?',
      'Does portability matter more than long-term seat life right now?',
      'Which stage actually fits your baby, your car, and the adults using it most?',
    ],
