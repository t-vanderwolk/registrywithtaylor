...
export const SERVICES_CREDENTIALS = {
  ...
  lead: 'Taylor is a Gugu Concierge with hands-on baby gear experience at Strolleria, Pottery Barn Kids, and Target’s Baby Concierge program. She has helped 200+ families. Her consultation recommendations are independent and never chosen because a brand paid to be included.',
  items: [
    { title: 'Gugu Concierge', body: 'A recognized baby registry and gear certification.' },
