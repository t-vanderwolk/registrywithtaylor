  ...
  '@graph': [
    {
      ...
      description:
        'Baby registry consultant and Gugu Concierge with hands-on baby gear experience at Strolleria, Pottery Barn Kids, and the Target Baby Concierge program. Founder of Taylor-Made Baby Co., having helped 200+ expecting parents build confident baby registries.',
      ...
      alumniOf: [
        ...
        { '@type': 'Organization', name: 'Gugu Concierge', url: 'https://gugu-guru.thinkific.com/courses/BabyConcierge', description: 'Baby registry and gear concierge program' },
      ],
      hasCredential: [
        {
          ...
          name: 'Gugu Concierge',
          recognizedBy: { '@type': 'Organization', name: 'Gugu Concierge', url: 'https://gugu-guru.thinkific.com/courses/BabyConcierge' },
        },
      ],
      knowsAbout: [
    ...
    },
    {
      ...
      description:
        'One hour virtual baby registry consultation for expecting parents covering stroller selection, car seat safety, nursery planning, feeding gear, and registry strategy. Delivered by Taylor Vanderwolk, Gugu Concierge who has helped 200+ families.',
    ...
    },
    {
      ...
      description:
        'A 4 step process to book and complete a 1 hour virtual baby registry consultation with Gugu Concierge Taylor Vanderwolk.',
      totalTime: 'PT1H',
