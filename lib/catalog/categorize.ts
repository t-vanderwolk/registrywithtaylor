...
const RULES: Rule[] = [
  ...
  // as a double.)
  // Nuna DEMI icon is a full-size, not a single-to-double like DEMI next/grow —
  // must precede the generic "demi" rule below.
  { re: /\bdemi icon\b/, category: 'Strollers', productType: 'full-size stroller', conf: 0.9, strong: true },
