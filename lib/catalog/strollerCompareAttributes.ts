...
const OVERRIDES: Override[] = [
  ...
  { brand: 'Silver Cross', match: /\bjet\b.*\bdouble\b|\bdouble\b.*\bjet\b/, modular: false, fitsOverheadBin: false, basketCapacity: 'Large' },
  ...
  { brand: 'Zoe', match: /(twin|deux|double)/, modular: false, fitsOverheadBin: false, basketCapacity: 'Large' },
  { brand: 'Zoe', match: /(tour|traveler|xl)/, modular: false, fitsOverheadBin: true, basketCapacity: 'Small' },
