...
const SCANNED_LOGO_SOURCES = [
  ...
  '/assets/logos/make-a-fortlogo.png',
  '/assets/logos/momcozy.png',
  '/assets/logos/munchkin.png',
...
const EXACT_LOGO_ALIASES: Record<string, string> = {
  ...
  angelbliss: '/assets/logos/angelbliss.png',
  ...
  munchkin: '/assets/logos/munchkin.png',
