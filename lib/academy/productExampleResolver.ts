...
const ACADEMY_PRODUCT_OVERRIDES: Partial<Record<string, Record<string, AcademyProductOverride>>> = {
  ...
  gliders: {
    [normalizeKey('Classic nursery glider setup')]: {
      ...
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.sereneNursery,
      imageAlt: 'Classic nursery glider setup.',
    },
    [normalizeKey('Reclining support chair')]: {
      name: 'Reclining support chair',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.tealNursery,
      imageAlt: 'Reclining nursery chair example.',
    },
    [normalizeKey('Compact upholstered nursery chair')]: {
      name: 'Compact upholstered nursery chair',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.simpleNursery,
  ...
  'dressers-changing': {
    ...
    [normalizeKey('Hatch Grow Changing Pad')]: {
      ...
      imageSrc: NURSERYPATH_IMAGES.hatchChangingPad,
      imageAlt: 'Hatch Grow changing pad.',
    },
  },
  'diaper-pails': {
