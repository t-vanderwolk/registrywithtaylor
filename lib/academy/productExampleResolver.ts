...
const ACADEMY_PRODUCT_OVERRIDES: Partial<Record<string, Record<string, AcademyProductOverride>>> = {
  ...
  'breast-pump': {
    ...
    [normalizeKey('Wearable Pump')]: {
      ...
      imageAlt: 'Momcozy Mobile Flow wearable pump.',
    },
    [normalizeKey('Manual Pump')]: {
      name: 'Munchkin Manual Breast Pump',
      brand: 'Munchkin',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.munchkin,
      imageSrc: GEARPATH_IMAGES.munchkinPump,
      imageAlt: 'Munchkin manual breast pump.',
    },
  },
} as const;
