...
const NURSERYPATH_IMAGES = {
  ...
  dadadaTopper: '/assets/nurserypath/dadadatopper.png',
  duplicate: '/assets/nurserypath/duplicate.png',
  glider: '/assets/nurserypath/glider.png',
  haloMiniMeshCrib: '/assets/nurserypath/halominimeshcrib.png',
  hatchChangingPad: '/assets/nurserypath/hatchchangingpad.png',
  ...
  miniCribMattress: '/assets/nurserypath/minicribmatressnewton.png',
  ...
  newtonNestCrib: '/assets/nurserypath/newtonnestcrib.png',
...
const ACADEMY_PRODUCT_OVERRIDES: Partial<Record<string, Record<string, AcademyProductOverride>>> = {
  ...
  cribs: {
    [normalizeKey('dadada Baby Convertible Crib')]: {
      name: 'dadada Baby Convertible Crib',
      brand: 'dadada Baby',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.dadadaBaby,
      imageSrc: NURSERYPATH_IMAGES.dadadaCrib,
    ...
    [normalizeKey('Newton Baby Original Crib Mattress')]: {
      name: 'Newton Baby Original Crib Mattress',
      brand: 'Newton Baby',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.newtonBaby,
      imageSrc: NURSERYPATH_IMAGES.newtonMattress,
    ...
    [normalizeKey('Newton Baby Mini Crib Mattress')]: {
      name: 'Newton Baby Mini Crib Mattress',
      brand: 'Newton Baby',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.newtonBaby,
      imageSrc: NURSERYPATH_IMAGES.miniCribMattress,
  ...
  gliders: {
    [normalizeKey('Classic nursery glider setup')]: {
      name: 'Classic nursery glider setup',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.glider,
      imageAlt: 'Classic nursery glider and ottoman setup.',
    },
    [normalizeKey('Reclining support chair')]: {
      name: 'Reclining support chair',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.kiwiRecliner,
      imageAlt: 'Reclining nursery chair with stronger arm and back support.',
    },
    [normalizeKey('Compact upholstered nursery chair')]: {
      name: 'Compact upholstered nursery chair',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.dresserAndRecliner,
      imageAlt: 'Smaller-footprint nursery chair beside dresser setup.',
    },
  },
  'dressers-changing': {
    [normalizeKey('dadada Baby Dresser + Changing Setup')]: {
      name: 'dadada Baby Dresser + Changing Setup',
      brand: 'dadada Baby',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.dadadaBaby,
      imageSrc: NURSERYPATH_IMAGES.dadadaDresser,
    ...
    [normalizeKey('Hatch Grow Changing Pad')]: {
      name: 'Hatch Grow Changing Pad',
      brand: 'Hatch',
      affiliateUrl: 'https://www.hatch.co',
      imageSrc: NURSERYPATH_IMAGES.hatchProductExample,
      imageAlt: 'Hatch Grow changing pad product example.',
    },
  },
  'diaper-pails': {
    [normalizeKey('Jool Baby Diaper Pail')]: {
      name: 'Jool Baby Diaper Pail',
      brand: 'Jool Baby',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.joolBaby,
      imageSrc: NURSERYPATH_IMAGES.joolBabyDiaperPail,
    ...
    [normalizeKey('Momcozy Diaper Pail')]: {
  ...
  'baby-monitors': {
    ...
    [normalizeKey('Momcozy Baby Monitor')]: {
  ...
  'baby-proofing': {
    [normalizeKey('Furniture anchoring pass')]: {
    ...
    [normalizeKey('Reach-zone floor sweep')]: {
      name: 'Reach-zone floor sweep',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.nurseryPlayroom,
      imageAlt: 'Nursery reach-zone safety example.',
    },
    [normalizeKey('Cord and blind management pass')]: {
      name: 'Cord and blind management pass',
      brand: '',
      affiliateUrl: null,
      imageSrc: NURSERYPATH_IMAGES.nurseryAtNight,
      imageAlt: 'Nighttime nursery safety example.',
    },
  },
  'layout-and-flow': {
    [normalizeKey('Dresser + Changing Setup')]: {
  ...
  'breast-pump': {
    ...
    [normalizeKey('Wearable Pump')]: {
      name: 'Momcozy Mobile Flow Wearable Pump',
      brand: 'Momcozy',
      affiliateUrl: CONTRACTED_AFFILIATE_LINKS.momcozy,
      imageSrc: GEARPATH_IMAGES.momcozyMobileFlow,
      imageAlt: 'Momcozy Mobile Flow wearable breast pump.',
    },
  ...
  'bottles-and-baby-utensils': {
    [normalizeKey('Bottle Starter Set')]: {
      name: 'Bottle Starter Set',
      brand: 'TMBC Guided Example',
      affiliateUrl: null,
      imageSrc: GEARPATH_IMAGES.storageBottles,
      imageAlt: 'Bottle starter set.',
    },
    [normalizeKey('Drying Rack and Brush Setup')]: {
      name: 'Drying Rack and Brush Setup',
      brand: 'TMBC Guided Example',
      affiliateUrl: null,
      imageSrc: GEARPATH_IMAGES.storageBottles,
      imageAlt: 'Bottle drying and reset workflow.',
    },
    [normalizeKey('Later-Stage Feeding Utensils')]: {
      name: 'Later-Stage Feeding Utensils',
      brand: 'TMBC Guided Example',
      affiliateUrl: null,
      imageSrc: GEARPATH_IMAGES.momcozyHighChair,
      imageAlt: 'Later-stage feeding setup.',
    },
  },
} as const;
