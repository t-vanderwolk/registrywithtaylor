...
const BRAND_INSIGHTS: Record<string, TravelSystemBrandInsight> = {
  ...
  'peg perego': {
    ...
    ecosystemType: 'semiClosed',
    ecosystemLabel: 'Semi-closed system',
    compatibilityPattern: 'Peg Perego works most naturally with its own infant seats, then uses adapter charts for the shared Nuna, Maxi-Cosi, CYBEX, and Clek lane.',
    supportedBrands: ['Peg Perego', 'Nuna', 'Maxi-Cosi', 'CYBEX', 'Clek'],
    tmbcInsight: 'Same-brand first, with a documented shared-adapter lane.',
  },
  romer: {
    brand: 'Romer',
    ecosystemType: 'closed',
...
const CAR_SEAT_INSIGHTS: Record<string, TravelSystemBrandInsight> = {
  ...
  'peg perego': {
    ...
    ecosystemType: 'semiClosed',
    ecosystemLabel: 'Semi-closed system',
    compatibilityPattern: 'Peg Perego works most naturally with Peg Perego strollers, then uses adapter charts for the shared Nuna, Maxi-Cosi, CYBEX, and Clek lane.',
    supportedBrands: ['Peg Perego', 'Nuna', 'Maxi-Cosi', 'CYBEX', 'Clek'],
    tmbcInsight: 'Same-brand first, with a documented shared-adapter lane.',
  },
  romer: {
