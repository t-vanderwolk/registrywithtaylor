...
const STROLLER_FAMILY_PATTERNS: Array<{ family: string; res: RegExp[] }> = [
  ...
  { family: 'Baby Jogger City Tour', res: [/\bcity tour\b/i] },
  { family: 'Baby Jogger City Mini', res: [/\bcity mini\b/i] },
  { family: 'Baby Jogger Summit', res: [/\bsummit\b/i] },
  { family: 'BOB Wayfinder', res: [/\bwayfinder\b/i] },
  { family: 'DFY R1', res: [/\br1\b/i] },
  { family: 'Ergobaby Metro', res: [/\bmetro\s*3?\b/i] },
  { family: 'Inglesina Quid', res: [/\bquid(?:\s*3|³)?\b/i] },
  { family: 'Mima Creo', res: [/\bcreo\b/i] },
  { family: 'Mima Miro', res: [/\bmiro\b/i] },
  { family: 'Mima Xari', res: [/\bxari\b/i] },
  { family: 'Peg Perego City Loop', res: [/\bcity loop\b/i] },
  { family: 'Peg Perego YPSI', res: [/\bypsi\b/i] },
  { family: 'Peg Perego Z4', res: [/\bz4\b/i] },
  { family: 'Silver Cross Cove', res: [/\bcove\s*2?\b/i] },
  { family: 'Silver Cross Nia', res: [/\bnia\b/i] },
  { family: 'Thule Spring', res: [/\bspring\b/i] },
  { family: 'Thule Urban Glide', res: [/\burban glide\b/i] },
  { family: 'Veer Cruiser', res: [/\bcruiser\b/i] },
  { family: 'Veer Switchback', res: [/\bswitchback\b/i] },
  { family: 'WonderFold W2', res: [/\bw2\b/i] },
  { family: 'WonderFold W4', res: [/\bw4\b/i] },
