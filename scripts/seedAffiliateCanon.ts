...
const affiliateCanon: AffiliateSeed[] = [
  ...
  },
  {
    ...
    network: AffiliateNetwork.IMPACT,
    commissionType: CommissionType.VARIABLE,
    commissionRate: '1-20% + $5 flat',
    notes: 'Variable rate: 1% base, up to 20% on select products, plus $5 flat per transaction.',
  },
  {
    name: 'Ladder Insurance',
    network: AffiliateNetwork.IMPACT,
    commissionType: CommissionType.CPL,
    commissionRate: '$125/lead',
    partnerType: 'service',
    notes: 'Life insurance lead gen. $125 per qualified application.',
  },
  {
    name: 'Angelbliss',
    network: AffiliateNetwork.IMPACT,
  ...
  },
  {
    name: 'Awin (USD)',
    advertiserId: '4032',
    website: 'https://www.affiliatewindow.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.CPL,
  ...
  },
  {
    ...
    commissionRate: '5%',
    isActive: false,
    notes: 'Not found in joined programmes — may not have been approved or program closed.',
  },
  {
    name: 'Baby Shusher',
    advertiserId: '118079',
  ...
  },
  {
    ...
    advertiserId: '68376',
    website: 'https://www.bellalunatoys.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.PERCENTAGE,
    commissionRate: '5%',
  },
  ...
  },
  {
    name: 'Inglesina',
    advertiserId: '69524',
    website: 'https://www.inglesina.us',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.PERCENTAGE,
    commissionRate: '0-15%',
  },
  ...
  },
  {
    name: 'Prosto Concept',
    advertiserId: '117623',
    website: 'https://prostoconcept.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.PERCENTAGE,
    commissionRate: '25%',
  },
  ...
  },
  {
    ...
    advertiserId: '59197',
    website: 'https://www.louloulollipop.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.PERCENTAGE,
    commissionRate: 'Varies',
    notes: 'Joined 17/08/25. Commission rate to be confirmed in Awin programme terms.',
  },
  {
    name: 'Joyrealtoys',
    advertiserId: '124026',
    website: 'https://joyrealtoys.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.PERCENTAGE,
    commissionRate: 'Varies',
    notes: 'Joined 11/02/26. Commission rate to be confirmed in Awin programme terms.',
  },
  {
    name: 'Cozeware',
    advertiserId: '123618',
    website: 'https://www.cozeware.com',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.VARIABLE,
    commissionRate: 'Varies',
    notes: 'Joined 19/03/26. Commission rate to be confirmed in Awin programme terms.',
  },
  {
    name: 'After The Tone Audio Guestbooks',
    advertiserId: '124956',
    website: 'https://www.afterthetone.co',
    network: AffiliateNetwork.AWIN,
    commissionType: CommissionType.VARIABLE,
    commissionRate: 'Varies',
    partnerType: 'service',
    notes: 'Joined 31/03/26. Audio guestbook service — non-gear contextual fit. Commission rate to be confirmed.',
  },
  {
    name: 'Babyark',
    network: AffiliateNetwork.AWIN,
    ...
    commissionType: CommissionType.VARIABLE,
    commissionRate: 'Varies',
    website: 'https://babyark.com',
    notes: 'Joined via Awin. Premium convertible car seat brand. Commission rate to be confirmed in Awin programme terms.',
  },
  {
    name: 'Nuby',
    network: AffiliateNetwork.AWIN,
    ...
    commissionType: CommissionType.VARIABLE,
    commissionRate: 'Varies',
    website: 'https://us.nuby.com',
    notes: 'Joined via Awin. Feeding, teething and toddler essentials. Commission rate to be confirmed in Awin programme terms.',
  },
  {
    name: 'Silver Cross',
