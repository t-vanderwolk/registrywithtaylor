...
export default function CarSeatRowEditor({ carSeat }: { carSeat: CarSeatRow }) {
  ...
  const c = carSeat;
  const previewImage = c.imageUrl || c.babylistImage;
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1.5 flex flex-wrap gap-1.5">
            ...
            {c.imageUrl ? <span className="rounded-full bg-[rgba(120,80,140,0.14)] px-2 py-0.5 text-[0.62rem] font-medium uppercase tracking-[0.1em] text-[#6b4b7a]">Custom image</span> : null}
