...
async function createAffiliateLink(formData: FormData) {
  ...
  if (!affiliateId || !destinationUrl) {
    redirect('/dashboard/admin/affiliate-links');
  }
  ...
  redirect(`/dashboard/admin/affiliate-links?created=${encodeURIComponent(shortCode)}`);
}
        ...
        <AdminToolbar
          left={
            <AdminTabs
              ...
              activeValue={sort}
              tabs={[
                { label: 'Most Recent', href: '/dashboard/admin/affiliate-links', value: 'recent' },
                { label: 'Most Clicked', href: '/dashboard/admin/affiliate-links?sort=clicks', value: 'clicks' },
              ]}
            />
          }
        />
