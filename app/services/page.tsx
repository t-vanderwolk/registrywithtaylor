...
export const metadata = buildMarketingMetadata({
  ...
  description:
    'Book a 1-hour virtual baby registry consultation with Gugu Concierge Taylor Vanderwolk for $75. Strollers, car seats, nursery, and registry strategy. Book your session today.',
  path: '/services',
