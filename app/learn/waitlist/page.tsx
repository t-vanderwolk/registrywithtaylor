...
export default function WaitlistPage() {
  ...
  return (
    <SiteShell currentPath="/learn/waitlist">
      <main className="site-main">
        <section className="bg-[linear-gradient(180deg,#fffdfb_0%,#fbf6f1_100%)] py-16 md:py-24">
          <div className="mx-auto max-w-5xl px-5 sm:px-8">

            {/* Back link */}
            <Link
              href="/learn"
              className="mb-12 inline-flex items-center gap-2 text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-[var(--color-accent-dark)] transition-opacity hover:opacity-70"
            >
            ...
            <div className="mt-10 grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-start lg:gap-16">
              ...
              <div>
                ...
                <div className="mt-10 grid gap-3 sm:grid-cols-2">
                  {paths.map((path) => (
                    <div
                      key={path.label}
                      className="rounded-[1.15rem] border border-[rgba(215,161,175,0.22)] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(252,247,244,0.93)_100%)] px-5 py-4 shadow-[0_6px_18px_rgba(72,49,56,0.04)]"
                    >
