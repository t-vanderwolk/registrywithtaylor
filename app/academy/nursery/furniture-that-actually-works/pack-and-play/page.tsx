...
const category = getNurseryFurnitureCategory('pack-and-play');
const path = getNurseryFurnitureCategoryPath('pack-and-play');
...
export default function NurseryFurniturePackAndPlayPage() {
  return (
    <SiteShell currentPath={path}>
      <main className="site-main min-h-0">
        <NurseryFurnitureCategoryRoute slug="pack-and-play" />
      </main>
    </SiteShell>
  );
}
