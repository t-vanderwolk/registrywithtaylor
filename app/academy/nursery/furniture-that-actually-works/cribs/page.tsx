...
const category = getNurseryFurnitureCategory('cribs');
const path = getNurseryFurnitureCategoryPath('cribs');
...
export default function NurseryFurnitureCribsPage() {
  return (
    <SiteShell currentPath={path}>
      <main className="site-main min-h-0">
        <PageViewTracker path={path} pageType="guide" slug="academy-nursery-furniture-cribs" title={category.title} />
        <NurseryFurnitureCategoryPage slug="cribs" />
      </main>
    </SiteShell>
  );
}
