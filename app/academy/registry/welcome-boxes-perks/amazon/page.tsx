...
const submodule = getRegistryWelcomeBoxesAcademySubmodule('amazon');
const path = getRegistryWelcomeBoxesAcademySubmodulePath('amazon');
...
export default function RegistryWelcomeBoxesAmazonPage() {
  return (
    <SiteShell currentPath={path}>
      <main className="site-main min-h-0">
        <RegistryWelcomeBoxesSubmodulePage slug="amazon" />
      </main>
    </SiteShell>
  );
}
