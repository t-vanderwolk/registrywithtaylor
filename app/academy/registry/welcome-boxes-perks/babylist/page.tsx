...
const submodule = getRegistryWelcomeBoxesAcademySubmodule('babylist');
const path = getRegistryWelcomeBoxesAcademySubmodulePath('babylist');
...
export default function RegistryWelcomeBoxesBabylistPage() {
  return (
    <SiteShell currentPath={path}>
      <main className="site-main min-h-0">
        <RegistryWelcomeBoxesSubmodulePage slug="babylist" />
      </main>
    </SiteShell>
  );
}
