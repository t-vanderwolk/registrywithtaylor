...
export const metadata = buildMarketingMetadata({
  ...
  description:
    'Meet Taylor Vanderwolk, baby registry consultant and Gugu Concierge with hands-on baby gear expertise. Book your $75 registry consult.',
  path: '/about',
