...
export const metadata = buildMarketingMetadata({
  ...
  description:
    'Get personalized baby gear, registry & nursery guidance from Gugu Concierge Taylor Vanderwolk. Every message read personally — response within 24 hours.',
  path: '/contact',
...
const CONTACT_FAQS: FAQEntry[] = [
  {
    ...
    answer:
      'A baby gear consultant is a specialist who helps expecting parents choose the right strollers, car seats, nursery furniture, and registry products based on their specific home, vehicle, lifestyle, and budget — rather than a generic “best of” list. Taylor at Taylor-Made Baby Co. brings hands-on experience from Strolleria and Pottery Barn Kids, plus Gugu Concierge training and experience in Target’s Baby Concierge program. She works with families virtually across the US.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Consultation recommendations are independent and never chosen because a brand paid to be included. They are based solely on fit for the parent’s specific home, car, routine, and budget — the same framework Taylor applied during her years as a hands-on specialist at Strolleria and as a Gugu Concierge. Some product links on the site are affiliate links, which means Taylor-Made Baby Co. may earn a small commission at no additional cost to you, and that never influences what Taylor recommends. Taylor-Made Baby Co. may also work with select brands on clearly disclosed editorial or content partnerships, which are always separate from what Taylor recommends in your session.',
  },
  {
...
const contactPageSchema = {
  ...
  description:
    'Reach out for personalized baby gear guidance, registry strategy, nursery planning, or consultation support from Gugu Concierge Taylor Vanderwolk. Every message is personally read — response within 24 hours.',
  ...
  mainEntity: {
    ...
    description:
      'Gugu Concierge and baby registry consultant with hands-on experience at Strolleria, Pottery Barn Kids, and Target Baby Concierge.',
  ...
  '@graph': [
    {
      ...
      description:
        'Independent, hands-on baby gear guidance for expecting parents — registry, stroller, car seat, and nursery planning from Gugu Concierge Taylor Vanderwolk. Virtual consultations, US Nationwide.',
      url: `${SITE_URL}/`,
      telephone: '+14807124347',
      email: 'hello@taylormadebabyco.com',
      priceRange: '$-$$$',
          ...
          <RevealOnScroll>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-7 text-[0.86rem] font-semibold text-neutral-800">
                Taylor — Gugu Concierge · Former Strolleria Baby Gear Specialist · 200+ Families Helped
              </p>
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 md:grid-cols-[minmax(0,1.28fr)_minmax(0,0.92fr)] md:gap-12">
              ...
              <div>
                ...
                <p className="mt-4 text-[0.97rem] leading-8 text-neutral-700">
                  This contact form goes directly to Taylor — a Gugu Concierge and baby registry
