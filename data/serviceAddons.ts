...
const serviceIcons = {
  ...
  grandparents: '/assets/icons/grandparents.png',
  nannyInterview: '/assets/icons/nannyinterview.png',
  nurseryRoom: '/assets/icons/nursery.png',
  sibling: '/assets/icons/sibling.png',
  sipSee: '/assets/icons/sipsee.png',
  stroller: '/assets/icons/stroller.png',
