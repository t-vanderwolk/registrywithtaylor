...
export default function GlossaryCard({ term, definition, whyItMatters }: GlossaryCardProps) {
  return (
    <div className="flex flex-col rounded-[1.4rem] border border-[var(--color-card-border)] bg-white p-6 shadow-[0_6px_22px_rgba(55,40,46,0.04)] transition duration-300 hover:-translate-y-0.5 hover:border-[rgba(216,137,160,0.5)] hover:shadow-[0_16px_38px_rgba(184,116,138,0.11)]">
