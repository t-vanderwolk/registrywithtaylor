...
export default function HomeEditorialBreak({
  ...
  return (
    <section className={`py-10 sm:py-12 md:py-20 ${toneClassName}`.trim()}>
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        <RevealOnScroll>
          <div className="relative isolate overflow-hidden rounded-[1.85rem] border border-[rgba(215,161,175,0.18)] bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(250,242,239,0.97)_100%)] p-4 shadow-[0_24px_54px_rgba(55,40,46,0.08)] sm:rounded-[2.35rem] sm:p-5 lg:p-6">
            ...
            <div className="relative grid gap-4 sm:gap-5 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-end">
              <div className="relative overflow-hidden rounded-[1.5rem] border border-white/80 bg-[linear-gradient(180deg,#fffdfa_0%,#f6eee6_100%)] shadow-[0_22px_48px_rgba(46,30,35,0.08)] sm:rounded-[2rem]">
                ...
                <div className="relative aspect-[16/10] min-h-[12.5rem] sm:min-h-[18rem] md:aspect-[16/8.6] md:min-h-[20rem]">
              ...
              <div className="rounded-[1.45rem] border border-[rgba(215,161,175,0.18)] bg-[linear-gradient(180deg,rgba(255,252,252,0.98)_0%,rgba(249,239,243,0.95)_100%)] p-4 shadow-[0_18px_36px_rgba(55,40,46,0.07)] sm:rounded-[1.65rem] sm:p-6">
                <p className="text-[0.68rem] uppercase tracking-[0.22em] text-[var(--color-accent-dark)]/82">{eyebrow}</p>
                <h3
                  className="mt-3 text-[1.95rem] font-semibold leading-[0.92] tracking-[0.01em] text-[#D986A2] sm:text-[2.65rem]"
                  style={{ fontFamily: '"Caveat", cursive' }}
                >
                  {title}
                </h3>
                <p className="mt-4 max-w-none text-[0.95rem] leading-6 sm:leading-7 text-[#5B4B55]">{description}</p>
                <div className="mt-5 sm:mt-6 text-[#D986A2]">
