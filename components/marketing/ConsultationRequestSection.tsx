...
export default function ConsultationRequestSection({
  ...
  return (
    <section
      id={id}
      className="relative z-10 overflow-visible bg-[linear-gradient(180deg,#fff6f7_0%,#fbf7f2_100%)] pt-16 pb-6 md:pt-28 md:pb-10"
    >
      ...
      <div className="relative z-20 mx-auto max-w-6xl px-5 sm:px-6">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.88fr)_minmax(20rem,1fr)] lg:items-start lg:gap-12 xl:gap-16">
          <RevealOnScroll>
            <div className="max-w-[36rem]">
              <div className="relative z-10">
                ...
                <h2 className="mt-4 font-serif text-[2rem] leading-[0.98] tracking-[-0.04em] text-neutral-900 sm:text-[2.9rem]">
                  Start with confidence.
                </h2>
                <p className="mt-5 max-w-none text-[1rem] leading-7 text-neutral-700 sm:leading-8">
          ...
          <RevealOnScroll delayMs={120}>
            <MarketingSurface className="relative overflow-hidden rounded-[1.5rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(252,247,244,0.94)_100%)] p-5 shadow-[0_24px_58px_rgba(55,40,46,0.06)] sm:rounded-[2rem] sm:p-8">
