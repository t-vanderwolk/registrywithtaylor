...
export default function GuideNextStep({
  ...
  const [hasTarget, setHasTarget] = useState(mode !== 'carousel');
  ...
  return (
    <Link
      href={href}
      className={[
        'group rounded-[1.5rem] border border-[rgba(215,161,175,0.16)] bg-[rgba(252,247,249,0.9)] p-5 transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_20px_50px_rgba(58,36,43,0.10)]',
        className,
      ]
        .filter(Boolean)
        .join(' ')}
