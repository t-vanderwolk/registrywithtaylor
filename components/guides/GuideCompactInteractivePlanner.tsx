    ...
    >
      ...
      <div className="mt-7 grid gap-5 sm:mt-8 sm:gap-6 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div>
          ...
          <div role="tablist" aria-label="Compact stroller routine planner" className="mt-4 grid gap-2.5 sm:grid-cols-2 sm:gap-3">
      ...
      <div className="mt-7 border-t border-[rgba(0,0,0,0.06)] pt-7 sm:mt-8 sm:pt-8">
        <div className="space-y-3">
          ...
          <div role="tablist" aria-label="Compact stroller tradeoff lenses" className="flex flex-wrap gap-2.5">
      ...
      {activeTopic ? (
        <div className="mt-7 border-t border-[rgba(0,0,0,0.06)] pt-7 sm:mt-8 sm:pt-8">
          ...
          <div className="mt-6 space-y-6">
            <div role="tablist" aria-label="Compact stroller guide topics" className="grid gap-2.5 sm:grid-cols-2 sm:gap-3 xl:grid-cols-3 2xl:grid-cols-4">
