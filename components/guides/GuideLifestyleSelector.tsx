      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
        {items.map((item) => (
          <Link
            ...
            href={item.href}
            className="group flex h-full flex-col rounded-2xl border border-neutral-200 bg-white p-6 transition hover:border-[#D7A1AF] hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(215,161,175,0.5)] focus-visible:ring-offset-4"
          >
            ...
            <h3 className="mt-5 font-serif text-[1.55rem] leading-tight tracking-tight text-neutral-900">
              {item.title}
            </h3>

            <p className="mt-3 max-w-[40ch] text-sm leading-relaxed text-neutral-700">{item.description}</p>
