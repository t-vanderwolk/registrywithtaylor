...
export default function GuideCTARibbon({
  ...
  return (
    <RevealOnScroll>
      <section
        id={id}
        className="rounded-2xl border border-[#F1D9DF] bg-gradient-to-br from-[#F8EDEE] to-[#FDF8F9] p-5 shadow-sm md:p-7"
      >
              ...
              {actions.map((action) => {
                ...
                return (
                  <Link
                    ...
                    href={action.href}
                    className={`inline-flex min-h-[44px] items-center justify-center rounded-full px-5 py-3 text-sm font-semibold transition-shadow duration-200 hover:shadow-md ${
                      isPrimary
