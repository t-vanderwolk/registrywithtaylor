    ...
    >
      {items.map((item, index) => (
        <a
          key={item.id}
          href={item.href}
          className="group min-w-[10.5rem] snap-start rounded-[1.2rem] border border-[rgba(215,161,175,0.18)] bg-white/82 p-3 shadow-[0_18px_55px_rgba(58,36,43,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_70px_rgba(58,36,43,0.12)] md:min-w-0 md:rounded-[1.5rem] md:p-5"
        >
          ...
          <h3 className="mt-3 text-[0.9rem] font-medium leading-5 text-[#2F2430] sm:text-lg sm:leading-6">{item.title}</h3>
