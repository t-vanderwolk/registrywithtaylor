...
export default function Cons({
  ...
  return (
    <section className="content-widget my-10 rounded-[20px] border border-[rgba(232,154,174,0.24)] bg-[linear-gradient(180deg,#ffffff_0%,#fdf3f6_100%)] px-5 py-5 shadow-[0_14px_36px_rgba(0,0,0,0.04)] sm:px-6 sm:py-6">
